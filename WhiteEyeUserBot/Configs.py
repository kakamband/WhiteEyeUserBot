...
if not ENV:
    ...
    class Config(object):
        ...
        ALIVE_NAME = os.environ.get("ALIVE_NAME", "WhiteEyeUser")
        ...
        # Tag Logger
        TAG_LOG = int(os.environ.get("TAG_LOG", -100))
        ...
        # set blacklist_chats where you do not want WhiteEyeUserbot's features
        ...
        ANONDEV_TOKEN = os.environ.get("ANONDEV_TOKEN", None)
