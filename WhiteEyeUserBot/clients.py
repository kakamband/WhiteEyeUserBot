...
if not Config.STRING_SESSION:
    hudson.warning("String Session is Missing, WhiteEyeUserBot is Quiting. Please Check ReadMe")
    quit(1)
...
if not Config.API_HASH:
    hudson.warning("Api Hash is Missing, WhiteEyeUserBot is Quiting. Please Check ReadMe")
    quit(1)
    
if not Config.PRIVATE_GROUP_ID:
    hudson.warning("Please Add Private Group ID For Proper Functioning Of WhiteEyeUserBot")
    quit(1)
