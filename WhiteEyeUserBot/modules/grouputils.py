...
@WhiteEye.on(WhiteEye_on_cmd(pattern="setgpic$"))
@WhiteEye.on(sudo_cmd(pattern="setgpic$", allow_sudo=True))
...
@WhiteEye.on(WhiteEye_on_cmd(pattern="promote(?: |$)(.*)"))
@WhiteEye.on(sudo_cmd(pattern="promote(?: |$)(.*)", allow_sudo=True))
...
@WhiteEye.on(WhiteEye_on_cmd(pattern="demote(?: |$)(.*)"))
@WhiteEye.on(sudo_cmd(pattern="demote(?: |$)(.*)", allow_sudo=True))
...
@WhiteEye.on(WhiteEye_on_cmd(pattern="ban(?: |$)(.*)"))
@WhiteEye.on(sudo_cmd(pattern="ban(?: |$)(.*)", allow_sudo=True))
async def ban(event):
    if event.fwd_from:
        return
    if not event.is_group:
...
@WhiteEye.on(WhiteEye_on_cmd(pattern="unban(?: |$)(.*)"))
@WhiteEye.on(sudo_cmd(pattern="unban(?: |$)(.*)", allow_sudo=True))
...
@WhiteEye.on(WhiteEye_on_cmd(pattern="unmute(?: |$)(.*)"))
@WhiteEye.on(sudo_cmd(pattern="unmute(?: |$)(.*)", allow_sudo=True))
...
@WhiteEye.on(WhiteEye_on_cmd(pattern="adminlist$"))
@WhiteEye.on(sudo_cmd(pattern="adminlist$", allow_sudo=True))
...
@WhiteEye.on(WhiteEye_on_cmd(pattern="pin(?: |$)(.*)"))
@WhiteEye.on(sudo_cmd(pattern="pin(?: |$)(.*)", allow_sudo=True))
async def pin(event):
    if event.fwd_from:
        return
...
@WhiteEye.on(WhiteEye_on_cmd(pattern="kick(?: |$)(.*)"))
@WhiteEye.on(sudo_cmd(pattern="kick(?: |$)(.*)", allow_sudo=True))
...
@WhiteEye.on(WhiteEye_on_cmd(pattern="users ?(.*)"))
@WhiteEye.on(sudo_cmd(pattern="users ?(.*)", allow_sudo=True))
...
@WhiteEye.on(WhiteEye_on_cmd("snips (.*)"))
async def on_snip_save(event):
    if event.fwd_from:
        return
    name = event.pattern_match.group(1)
...
@WhiteEye.on(WhiteEye_on_cmd("snipl"))
async def on_snip_list(event):
    if event.fwd_from:
        return
...
@WhiteEye.on(WhiteEye_on_cmd("snipd (\S+)"))
async def on_snip_delete(event):
    if event.fwd_from:
        return
    name = event.pattern_match.group(1)
...
@WhiteEye.on(WhiteEye_on_cmd(pattern="rwarn(?: |$)(.*)"))
async def _(event):
    if event.fwd_from:
        return
    if not event.is_group:
...
@WhiteEye.on(WhiteEye_on_cmd(pattern="allwarns(?: |$)(.*)"))
async def __(event):
    if event.fwd_from:
        return
    if not event.is_group:
...
@WhiteEye.on(WhiteEye_on_cmd(pattern="slimit ?(.*)"))
async def m_(event):
    if event.fwd_from:
        return
    if not event.is_group:
...
@WhiteEye.on(WhiteEye_on_cmd(pattern="wap ?(.*)"))
async def m_(event):
    if event.fwd_from:
        return
    if not event.is_group:
...
@WhiteEye.on(WhiteEye_on_cmd(pattern="savewelcome"))
async def _(event):
    if event.fwd_from:
        return
    msg = await event.get_reply_message()
...
@WhiteEye.on(WhiteEye_on_cmd(pattern="clearwelcome$"))  # pylint:disable=E0602
async def _(event):
    if event.fwd_from:
        return
    cws = get_current_welcome_settings(event.chat_id)
...
@WhiteEye.on(WhiteEye_on_cmd(pattern="listwelcome$"))  # pylint:disable=E0602
async def _(event):
    if event.fwd_from:
        return
    cws = get_current_welcome_settings(event.chat_id)
